...
<body>
    <div id="title">Remove Money from Account</div>
    ...
    <div id="verticalContainer">
        <div id="horizontalContainer">
            ...
            <input type="text" id="titleInput" placeholder="ex. Lunch">
        </div>
        <div id="horizontalContainer">
            <div id="subtitle">Amount : </div>
            <div id = "inside">
                <div id="subtitleMoney">-$ </div>
                <input type="text" id="amountInput" placeholder="ex. 19.50">
            </div>
        </div>
        <div id="horizontalContainer">
        ...
        <div id="verticalContainerInside">
            ...
            <input type="text" id="descriptionInput" placeholder="ex. Bought Lunch at Subway">
        </div>
    </div>
    <div id="buttonHolder">
