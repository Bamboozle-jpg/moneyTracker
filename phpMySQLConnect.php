...
<body>
    ...
    <?php
        ...
        try {
            ...
            while ($r = $q->fetch()) { ?>
                <div id='title'> <?php echo sprintf('%s <br/>', $r['id']); ?></div>
                <div id='Test'> <?php echo sprintf('%s <br/>', $r['numOfSomething']); ?></div>
                <div id='Test'> <?php echo sprintf('%s <br/>', $r['date']); ?></div>
                <div id='Test'> <?php echo sprintf('%s <br/>', $r['location']); ?></div>
                <div id='Test'> <?php echo sprintf('%s <br/>', $r['title']); ?></div>
                <div id="line1"></div>
            <?php }
    ...
    <div id="Test">More info Here $32.35</div>
    <div id="line1"></div>
    <div id="title">Third description of what I used it for</div>
    <div id="Test">Even more info Here $21.35</div>
    <div id="line1"></div>
</body>
